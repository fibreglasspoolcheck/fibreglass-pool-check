  ...
  await sendEmail({
    ...
    htmlContent: `
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; color: #1e293b;">
        ...
        <p style="margin-top: 16px; font-size: 14px;">Files are in the <a href="https://supabase.com/dashboard/project/rmbjqgkvtflzrqzxmnjm" style="color: #ea580c;">Supabase dashboard</a> under Storage → order-files → ${orderId}/</p>
      </div>
    `,
  })
}
