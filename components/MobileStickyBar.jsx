...
export default function MobileStickyBar({
  ...
  return (
    <div
      className={`fixed bottom-0 left-0 right-0 bg-cream border-t border-border-warm px-4 py-3 lg:hidden z-50 transition-transform duration-300 ${
    ...
    >
      <div className="flex items-center justify-between max-w-6xl mx-auto">
        <div>
          ...
          <div className="text-warm-grey text-xs">{subtitle}</div>
        </div>
        <Link
          href={href}
