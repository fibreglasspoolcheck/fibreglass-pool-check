    ...
    <>
      ...
      <article className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="prose prose-slate max-w-none">
          ...
          <h2 className="text-2xl font-bold text-slate-900 mt-10 mb-4">What is fibreglass pool delamination?</h2>
          ...
          <h2 className="text-2xl font-bold text-slate-900 mt-10 mb-4">What does delamination look like?</h2>
          <p className="text-slate-600 leading-relaxed">
          ...
          <h2 className="text-2xl font-bold text-slate-900 mt-10 mb-4">What causes delamination?</h2>
          <p className="text-slate-600 leading-relaxed">
            There's rarely a single cause. Most delamination I see is a combination of factors:
          </p>

          <h3 className="text-xl font-semibold text-slate-800 mt-6 mb-3">Age and wear</h3>
          <p className="text-slate-600 leading-relaxed">
          ...
          <h3 className="text-xl font-semibold text-slate-800 mt-6 mb-3">Poor manufacturing</h3>
          <p className="text-slate-600 leading-relaxed">
          ...
          <h3 className="text-xl font-semibold text-slate-800 mt-6 mb-3">Chemical imbalance</h3>
          <p className="text-slate-600 leading-relaxed">
          ...
          <h3 className="text-xl font-semibold text-slate-800 mt-6 mb-3">Sun and UV exposure</h3>
          <p className="text-slate-600 leading-relaxed">
          ...
          <h3 className="text-xl font-semibold text-slate-800 mt-6 mb-3">Water ingress (osmosis)</h3>
          <p className="text-slate-600 leading-relaxed">
          ...
          <h2 className="text-2xl font-bold text-slate-900 mt-10 mb-4">How serious is it?</h2>
          <p className="text-slate-600 leading-relaxed">
            It depends entirely on the extent and location. I categorise delamination into two broad buckets:
          </p>

          <h3 className="text-xl font-semibold text-slate-800 mt-6 mb-3">Minor / cosmetic</h3>
          <p className="text-slate-600 leading-relaxed">
          ...
          <h3 className="text-xl font-semibold text-slate-800 mt-6 mb-3">Widespread / structural concern</h3>
          <p className="text-slate-600 leading-relaxed">
          ...
          <h2 className="text-2xl font-bold text-slate-900 mt-10 mb-4">Repair options and costs</h2>
          <p className="text-slate-600 leading-relaxed">
          ...
          <h3 className="text-xl font-semibold text-slate-800 mt-6 mb-3">Patch repair: $500 – $2,000</h3>
          <p className="text-slate-600 leading-relaxed">
          ...
          <h3 className="text-xl font-semibold text-slate-800 mt-6 mb-3">Full resurface: $8,000 – $15,000+</h3>
          <p className="text-slate-600 leading-relaxed">
          ...
          <div className="bg-slate-50 border border-slate-200 rounded-xl p-6 my-8">
            <p className="text-sm text-slate-800 font-medium mb-1">Not sure which repair you need?</p>
            <p className="text-sm text-slate-600">
              A <Link href="/PoolCheckReport/order" className="underline font-medium text-orange-600">Pool Check Report</Link> gives you a clear assessment of the damage and a realistic cost estimate based on your specific pool. No guesswork.
            </p>
          </div>

          <h2 className="text-2xl font-bold text-slate-900 mt-10 mb-4">Can you keep swimming?</h2>
          <p className="text-slate-600 leading-relaxed">
          ...
          <h2 className="text-2xl font-bold text-slate-900 mt-10 mb-4">When it's urgent vs when it can wait</h2>
          <p className="text-slate-600 leading-relaxed">
          ...
          <h2 className="text-2xl font-bold text-slate-900 mt-10 mb-4">How to monitor delamination</h2>
          <p className="text-slate-600 leading-relaxed">
          ...
          <h2 className="text-2xl font-bold text-slate-900 mt-10 mb-4">Gold Coast or South-East Queensland?</h2>
          <p className="text-slate-600 leading-relaxed">
        ...
        <div className="bg-slate-900 rounded-xl p-8 mt-12 text-center">
          <h3 className="text-xl font-bold text-white mb-3">Not sure how serious your pool's delamination is?</h3>
          <p className="text-slate-300 text-sm mb-6 max-w-md mx-auto">
            Upload photos and get a written expert assessment with repair recommendations and realistic cost estimates.
          </p>
          ...
          <p className="text-slate-400 text-xs mt-3 italic">
            Clear, actionable findings  -  or I'll make it right.
          </p>
        </div>
