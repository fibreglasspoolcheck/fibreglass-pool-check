    ...
    <>
      ...
      <article className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="prose prose-slate max-w-none">
          ...
          <h2 className="text-2xl font-bold text-slate-900 mt-10 mb-4">The short answer: 25 to 30+ years for the shell</h2>
          ...
          <h2 className="text-2xl font-bold text-slate-900 mt-10 mb-4">The gelcoat surface: 10 to 15 years</h2>
          <p className="text-slate-600 leading-relaxed">
          ...
          <h2 className="text-2xl font-bold text-slate-900 mt-10 mb-4">Equipment lifespan: 5 to 15 years depending on the item</h2>
          <p className="text-slate-600 leading-relaxed">
          ...
          <h2 className="text-2xl font-bold text-slate-900 mt-10 mb-4">What actually determines how long your pool lasts</h2>
          <p className="text-slate-600 leading-relaxed">
            Here are the six factors I see making the biggest difference:
          </p>

          <h3 className="text-xl font-semibold text-slate-800 mt-8 mb-3">1. Manufacturing quality</h3>
          <p className="text-slate-600 leading-relaxed">
          ...
          <h3 className="text-xl font-semibold text-slate-800 mt-8 mb-3">2. Installation quality</h3>
          <p className="text-slate-600 leading-relaxed">
          ...
          <h3 className="text-xl font-semibold text-slate-800 mt-8 mb-3">3. Water chemistry</h3>
          <p className="text-slate-600 leading-relaxed">
          ...
          <h3 className="text-xl font-semibold text-slate-800 mt-8 mb-3">4. UV exposure</h3>
          <p className="text-slate-600 leading-relaxed">
          ...
          <h3 className="text-xl font-semibold text-slate-800 mt-8 mb-3">5. Ground conditions</h3>
          <p className="text-slate-600 leading-relaxed">
          ...
          <h3 className="text-xl font-semibold text-slate-800 mt-8 mb-3">6. Ongoing maintenance</h3>
          <p className="text-slate-600 leading-relaxed">
          ...
          <h2 className="text-2xl font-bold text-slate-900 mt-10 mb-4">Signs your fibreglass pool is ageing</h2>
          <p className="text-slate-600 leading-relaxed">
          ...
          <h2 className="text-2xl font-bold text-slate-900 mt-10 mb-4">When should you actually worry?</h2>
          <p className="text-slate-600 leading-relaxed">
          ...
          <h2 className="text-2xl font-bold text-slate-900 mt-10 mb-4">Fibreglass vs concrete: which lasts longer?</h2>
          <p className="text-slate-600 leading-relaxed">
          ...
          <h2 className="text-2xl font-bold text-slate-900 mt-10 mb-4">How to maximise your pool's lifespan</h2>
          <p className="text-slate-600 leading-relaxed">
          ...
          <p className="text-slate-600 leading-relaxed">
            If your pool is showing signs of ageing and you want to know where it sits  -  whether it needs attention now or has years of life left  -  the <Link href="/PoolCheckReport/order" className="text-orange-600 hover:underline font-medium">Pool Check Report ($149)</Link> gives you a written assessment based on photos of your pool. I'll tell you what's normal wear, what needs watching, and what needs fixing.
          </p>
          <p className="text-slate-600 leading-relaxed mt-3">
            If you're buying a property with a pool and want to understand what you're getting into, the same report works as a pre-purchase assessment. Pair it with the free <Link href="/RedFlagsGuide" className="text-orange-600 hover:underline font-medium">Red Flags Guide</Link> so you know what to photograph at the inspection.
          </p>
        </div>

        {/* CTA */}
        <div className="bg-slate-900 rounded-xl p-8 mt-12 text-center">
          <h3 className="text-xl font-bold text-white mb-3">How much life does your pool have left?</h3>
          <p className="text-slate-300 text-sm mb-6 max-w-md mx-auto">
            Get a written assessment from a fibreglass specialist  -  know exactly where your pool stands.
          </p>
          <Link
          ...
          <p className="text-slate-400 text-xs mt-3 italic">
            Honest assessment, no upselling. If your pool is fine, I'll tell you it's fine.
          </p>
        </div>
