    ...
    <>
      ...
      <article className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="prose prose-slate max-w-none">
          ...
          <h2 className="text-2xl font-bold text-slate-900 mt-10 mb-4">The quick answer: $2,000 to $4,500 per year</h2>
          ...
          <h2 className="text-2xl font-bold text-slate-900 mt-10 mb-4">Annual cost breakdown</h2>

          <div className="overflow-x-auto my-6">
            <table className="w-full text-sm text-left border border-slate-200 rounded-lg">
              <thead className="bg-slate-50">
                <tr>
                  <th className="px-4 py-3 font-semibold text-slate-700 border-b border-slate-200">Expense</th>
                  <th className="px-4 py-3 font-semibold text-slate-700 border-b border-slate-200">Annual cost range</th>
                </tr>
              </thead>
          ...
          <h2 className="text-2xl font-bold text-slate-900 mt-10 mb-4">Chemicals: $400 to $800 per year</h2>
          <p className="text-slate-600 leading-relaxed">
          ...
          <h2 className="text-2xl font-bold text-slate-900 mt-10 mb-4">Electricity: $600 to $1,500 per year</h2>
          <p className="text-slate-600 leading-relaxed">
          ...
          <h2 className="text-2xl font-bold text-slate-900 mt-10 mb-4">Water: $100 to $300 per year</h2>
          <p className="text-slate-600 leading-relaxed">
          ...
          <h2 className="text-2xl font-bold text-slate-900 mt-10 mb-4">Pool servicing: $0 to $2,400 per year</h2>
          <p className="text-slate-600 leading-relaxed">
          ...
          <h2 className="text-2xl font-bold text-slate-900 mt-10 mb-4">Insurance: $100 to $300 per year</h2>
          <p className="text-slate-600 leading-relaxed">
          ...
          <h2 className="text-2xl font-bold text-slate-900 mt-10 mb-4">Pool safety compliance: $50 to $200 per year</h2>
          <p className="text-slate-600 leading-relaxed">
          ...
          <h2 className="text-2xl font-bold text-slate-900 mt-10 mb-4">The costs nobody warns you about: major maintenance</h2>
          <p className="text-slate-600 leading-relaxed">
          ...
          <div className="overflow-x-auto my-6">
            <table className="w-full text-sm text-left border border-slate-200 rounded-lg">
              <thead className="bg-slate-50">
                <tr>
                  <th className="px-4 py-3 font-semibold text-slate-700 border-b border-slate-200">Major expense</th>
                  <th className="px-4 py-3 font-semibold text-slate-700 border-b border-slate-200">Cost</th>
                  <th className="px-4 py-3 font-semibold text-slate-700 border-b border-slate-200">Frequency</th>
                </tr>
              </thead>
              <tbody className="text-slate-600">
                <tr className="border-b border-slate-100">
          ...
          <h2 className="text-2xl font-bold text-slate-900 mt-10 mb-4">Fibreglass vs concrete: running cost comparison</h2>
          <p className="text-slate-600 leading-relaxed">
          ...
          <h2 className="text-2xl font-bold text-slate-900 mt-10 mb-4">How to reduce your pool running costs</h2>
          <p className="text-slate-600 leading-relaxed">
          ...
          <h2 className="text-2xl font-bold text-slate-900 mt-10 mb-4">The bottom line: is a pool worth it financially?</h2>
          <p className="text-slate-600 leading-relaxed">
          ...
          <p className="text-slate-600 leading-relaxed">
            If you're buying a property with a pool and want to know what condition it's in  -  and what repairs might be coming  -  the <Link href="/PoolCheckReport/order" className="text-orange-600 hover:underline font-medium">Pool Check Report ($149)</Link> gives you a clear picture of what you're taking on.
          </p>
          <p className="text-slate-600 leading-relaxed mt-3">
            If you want to assess the pool yourself at an open home, grab the free <Link href="/RedFlagsGuide" className="text-orange-600 hover:underline font-medium">Red Flags Guide</Link>  -  it shows you the most common problems and what they typically cost to fix. Or use the <Link href="/BuyerChecklist" className="text-orange-600 hover:underline font-medium">Buyer Checklist ($29)</Link> for a complete structured assessment you can do yourself.
          </p>
        </div>

        {/* CTA */}
        <div className="bg-slate-900 rounded-xl p-8 mt-12 text-center">
          <h3 className="text-xl font-bold text-white mb-3">Buying a property with a pool?</h3>
          <p className="text-slate-300 text-sm mb-6 max-w-md mx-auto">
            Know what you're getting into before you sign. Get an independent assessment from a fibreglass pool specialist.
          </p>
          <div className="flex flex-col sm:flex-row gap-3 justify-center">
            ...
            <Link
              href="/RedFlagsGuide"
              className="inline-block border border-slate-600 hover:border-slate-400 text-white px-6 py-3 rounded-lg font-medium transition-colors"
            >
