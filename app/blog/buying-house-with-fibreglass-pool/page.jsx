    ...
    <>
      ...
      <article className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="bg-slate-900 rounded-xl p-8 mt-12 text-center">
          <h3 className="text-xl font-bold text-white mb-3">Don't rely on a building inspector for pool assessment</h3>
          <p className="text-slate-300 text-sm mb-6 max-w-md mx-auto">
            Get an independent written report from a fibreglass pool specialist before you exchange contracts.
          </p>
          <Link
