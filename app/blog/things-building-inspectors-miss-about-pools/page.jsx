    ...
    <>
      ...
      <article className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="prose prose-slate max-w-none">
          ...
          <h2 className="text-2xl font-bold text-slate-900 mt-10 mb-4">1. Osmotic blistering below the waterline</h2>
          ...
          <h2 className="text-2xl font-bold text-slate-900 mt-10 mb-4">2. Early-stage delamination</h2>
          <p className="text-slate-600 leading-relaxed">
          ...
          <h2 className="text-2xl font-bold text-slate-900 mt-10 mb-4">3. Shell flex and backfill problems</h2>
          <p className="text-slate-600 leading-relaxed">
          ...
          <h2 className="text-2xl font-bold text-slate-900 mt-10 mb-4">4. Fitting failure and hidden leaks</h2>
          <p className="text-slate-600 leading-relaxed">
          ...
          <h2 className="text-2xl font-bold text-slate-900 mt-10 mb-4">5. Gelcoat chemical damage at the waterline</h2>
          <p className="text-slate-600 leading-relaxed">
          ...
          <h2 className="text-2xl font-bold text-slate-900 mt-10 mb-4">6. Equipment at end of life</h2>
          <p className="text-slate-600 leading-relaxed">
          ...
          <h2 className="text-2xl font-bold text-slate-900 mt-10 mb-4">7. Pool shell age and history</h2>
          <p className="text-slate-600 leading-relaxed">
          ...
          <h2 className="text-2xl font-bold text-slate-900 mt-10 mb-4">8. Coping separation and drainage issues</h2>
          <p className="text-slate-600 leading-relaxed">
          ...
          <h2 className="text-2xl font-bold text-slate-900 mt-10 mb-4">9. Floor condition and groundwater pressure</h2>
          <p className="text-slate-600 leading-relaxed">
          ...
          <h2 className="text-2xl font-bold text-slate-900 mt-10 mb-4">10. Previous repair work (good and bad)</h2>
          <p className="text-slate-600 leading-relaxed">
          ...
          <h2 className="text-2xl font-bold text-slate-900 mt-10 mb-4">Why this happens  -  and what to do about it</h2>
          <p className="text-slate-600 leading-relaxed">
          ...
          <p className="text-slate-600 leading-relaxed">
            If you're heading to open homes and want to know what to look for, grab the free <Link href="/RedFlagsGuide" className="text-orange-600 hover:underline font-medium">Red Flags Guide</Link>. It covers the most common problems with photos and plain-language explanations, so you know what to photograph and what questions to ask.
          </p>
          <p className="text-slate-600 leading-relaxed mt-3">
            If you're serious about a specific property and want a specialist opinion before you commit, the <Link href="/PoolCheckReport/order" className="text-orange-600 hover:underline font-medium">Pool Check Report ($149)</Link> gives you a written assessment based on pool photos. I'll tell you what the building inspector missed, what repairs are likely needed, and what you should budget for.
          </p>
          <p className="text-slate-600 leading-relaxed mt-3">
            And if you want to do a thorough self-assessment of the pool at inspection, the <Link href="/BuyerChecklist" className="text-orange-600 hover:underline font-medium">Buyer Checklist ($29)</Link> walks you through every check point a specialist would cover, in plain language.
          </p>
        </div>

        {/* CTA */}
        <div className="bg-slate-900 rounded-xl p-8 mt-12 text-center">
          <h3 className="text-xl font-bold text-white mb-3">Don't let a building inspector be your only pool assessment</h3>
          <p className="text-slate-300 text-sm mb-6 max-w-md mx-auto">
            Get a specialist pool assessment before you exchange contracts. It could save you thousands.
          </p>
