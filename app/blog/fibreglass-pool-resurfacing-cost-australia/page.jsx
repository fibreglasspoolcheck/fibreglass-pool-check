          ...
          <div className="grid lg:grid-cols-3 gap-12">
            <div className="lg:col-span-2">
              <div className="prose max-w-none">
                ...
                <h2 className="font-serif text-2xl text-ink mt-10 mb-4">Average fibreglass pool resurfacing costs in Australia (2026)</h2>
                ...
                <h2 className="font-serif text-2xl text-ink mt-10 mb-4">What affects the price</h2>
                <p className="text-ink-light leading-relaxed">
                ...
                <h3 className="text-xl font-semibold text-ink mt-8 mb-3">1. Pool size and shape</h3>
                <p className="text-ink-light leading-relaxed">
                ...
                <h3 className="text-xl font-semibold text-ink mt-8 mb-3">2. Current condition of the surface</h3>
                <p className="text-ink-light leading-relaxed">
                ...
                <h3 className="text-xl font-semibold text-ink mt-8 mb-3">3. Access to the pool</h3>
                <p className="text-ink-light leading-relaxed">
                ...
                <h3 className="text-xl font-semibold text-ink mt-8 mb-3">4. Coating system used</h3>
                <p className="text-ink-light leading-relaxed">
                ...
                <h3 className="text-xl font-semibold text-ink mt-8 mb-3">5. Your region</h3>
                <p className="text-ink-light leading-relaxed">
                ...
                <h3 className="text-xl font-semibold text-ink mt-8 mb-3">6. Whether the pool needs to be drained and dried</h3>
                <p className="text-ink-light leading-relaxed">
                ...
                <h2 className="font-serif text-2xl text-ink mt-10 mb-4">Patch repair vs full resurface  -  which do you actually need?</h2>
                <p className="text-ink-light leading-relaxed">
                ...
                <h2 className="font-serif text-2xl text-ink mt-10 mb-4">When resurfacing is worth it  -  and when it's not</h2>
                <p className="text-ink-light leading-relaxed">
                ...
                <h2 className="font-serif text-2xl text-ink mt-10 mb-4">Gold Coast and SEQ pricing context</h2>
                <p className="text-ink-light leading-relaxed">
                ...
                <h2 className="font-serif text-2xl text-ink mt-10 mb-4">Questions to ask your resurfacing contractor</h2>
                <p className="text-ink-light leading-relaxed">
                ...
                <h2 className="font-serif text-2xl text-ink mt-10 mb-4">How to tell if you're being overquoted</h2>
                <p className="text-ink-light leading-relaxed">
                ...
                <h2 className="font-serif text-2xl text-ink mt-10 mb-4">If you're on the Gold Coast or in SEQ</h2>
                <p className="text-ink-light leading-relaxed">
                  I also run <a href="https://brefibreglass.com.au" target="_blank" rel="noopener noreferrer" className="text-accent hover:underline font-medium">BRE Fibreglass</a>, where I do hands-on fibreglass pool repairs and resurfacing across the Gold Coast and South East Queensland. If your pool needs work and you're in the area, you can get in touch through that site for a direct quote.
                </p>
                <p className="text-ink-light leading-relaxed mt-3">
                ...
                <p className="text-ink-light leading-relaxed">
                  If your pool surface is showing its age and you want to understand what you're dealing with before talking to contractors, the <Link href="/PoolCheckReport/order" className="text-accent hover:underline font-medium">Pool Check Report ($149)</Link> gives you a written assessment of your pool's condition, likely repair needs, and what you should expect to pay  -  based on photos you send me.
                </p>
                <p className="text-ink-light leading-relaxed mt-3">
                  If you want to understand what your pool actually needs before committing to repairs, the <Link href="/PoolCheckReport" className="text-accent hover:underline font-medium">Pool Check Report</Link> gives you an independent assessment.
                </p>
                <p className="text-ink-light leading-relaxed mt-3">
                  And if you just want to learn more about the warning signs of pool surface failure, grab the free <Link href="/RedFlagsGuide" className="text-accent hover:underline font-medium">Red Flags Guide</Link>  -  it covers the most common problems I see and what they typically mean.
                </p>
              </div>
            </div>
            <ContentSidebar />
