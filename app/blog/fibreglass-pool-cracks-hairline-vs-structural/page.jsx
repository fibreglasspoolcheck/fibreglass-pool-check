          ...
          <div className="grid lg:grid-cols-3 gap-12">
            <div className="lg:col-span-2">
              <div className="prose max-w-none">
                ...
                <h2 className="font-serif text-2xl text-ink mt-10 mb-4">The three types of cracks in fibreglass pools</h2>
                <p className="text-ink-light leading-relaxed">
                  Before we get into specifics, here's the quick overview. Fibreglass pool cracks fall into three categories:
                </p>
                <ol className="list-decimal list-inside text-ink-light leading-relaxed mt-3 space-y-2">
                ...
                <h2 className="font-serif text-2xl text-ink mt-10 mb-4">Surface crazing (hairline cracks)</h2>
                <p className="text-ink-light leading-relaxed">
                ...
                <h3 className="text-xl font-semibold text-ink mt-8 mb-3">What causes it</h3>
                <p className="text-ink-light leading-relaxed">
                ...
                <h3 className="text-xl font-semibold text-ink mt-8 mb-3">Repair options and costs</h3>
                <ul className="list-disc list-inside text-ink-light leading-relaxed mt-3 space-y-2">
                ...
                <h2 className="font-serif text-2xl text-ink mt-10 mb-4">Gelcoat cracks</h2>
                <p className="text-ink-light leading-relaxed">
                ...
                <h2 className="font-serif text-2xl text-ink mt-10 mb-4">Structural cracks</h2>
                <p className="text-ink-light leading-relaxed">
                ...
                <h2 className="font-serif text-2xl text-ink mt-10 mb-4">How to tell the difference: a practical test</h2>
                <p className="text-ink-light leading-relaxed">
                ...
                <h2 className="font-serif text-2xl text-ink mt-10 mb-4">DIY repair vs professional: where's the line?</h2>
                <p className="text-ink-light leading-relaxed">
                ...
                <p className="text-ink-light leading-relaxed">
                  If you've found a crack and you're not sure what type it is, the safest next step is to get it assessed. The <Link href="/PoolCheckReport/order" className="text-accent hover:underline font-medium">Pool Check Report ($149)</Link> lets you send me photos of the crack and surrounding area, and I'll give you a written assessment of what you're dealing with, what caused it, and what it'll cost to fix.
                </p>
                <p className="text-ink-light leading-relaxed mt-3">
                  If you're in the early stages of assessing a pool  -  maybe buying a property or just wanting to understand what you're looking at  -  the free <Link href="/RedFlagsGuide" className="text-accent hover:underline font-medium">Red Flags Guide</Link> shows you photos of the most common problems so you can spot them yourself.
                </p>
                <p className="text-ink-light leading-relaxed mt-3">
                  And if you want a structured way to assess the pool yourself, the <Link href="/BuyerChecklist" className="text-accent hover:underline font-medium">Buyer Checklist ($29)</Link> walks you through every inspection point in plain language.
                </p>
              </div>
            </div>
            <ContentSidebar />
