    ...
    <section className="py-20">
      <div className="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <p className="text-slate-600 leading-relaxed mb-8">
          Check your inbox — we've sent the Fibreglass Pool Red Flags Guide to your email address. If you don't see it within a few minutes, check your spam or junk folder.
        </p>
        <div className="bg-slate-50 border border-slate-200 rounded-xl p-6 text-left">
          ...
          <p className="text-slate-600 text-sm leading-relaxed mb-4">
            If you're seriously considering buying a property with a fibreglass pool, our Pool Check Report gives you a full specialist assessment based on photos of the specific pool you're looking at.
          </p>
          <a
